...
public class UpbitGetOrderResponse {
    ...
    @Builder
    private UpbitGetOrderResponse(String uuid, String side, String ordType, String price,
            UpbitOrderEnums.State state, String createdAt, String volume, String paidFee,
