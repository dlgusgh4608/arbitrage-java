...
public class AutomaticOrder {
  ...
  private final List<BuyOrder> openOrders = new ArrayList<>();
  ...
  private void sellBinance(String symbolName, double qty, double price) {
    binanceService.createOrder(
        symbolName, BinanceEnums.Side.SELL, BinanceEnums.Type.LIMIT, qty, price, true);
  }

  private void buyBinance(String symbolName, double qty, double price) {
    binanceService.createOrder(
        symbolName, BinanceEnums.Side.BUY, BinanceEnums.Type.LIMIT, qty, price, true);
  }
