package main.arbitrage.infrastructure.binance.dto.request;

import com.fasterxml.jackson.annotation.JsonInclude;
import lombok.Builder;
import lombok.Getter;
import main.arbitrage.infrastructure.binance.dto.enums.BinanceEnums.Side;
import main.arbitrage.infrastructure.binance.dto.enums.BinanceEnums.TimeInForce;
...
public class BinancePostOrderRequest {
  ...
  @Builder
  public BinancePostOrderRequest(
      String newClientOrderId, Type type, String symbol, Side side, Double quantity, Double price) {
